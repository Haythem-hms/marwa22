...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- TITLE OF SITE -->
        <title>MomsProcoaching - coach de vie pour les mammans</title>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="single-slide-item-content">
											<h2>Consultez Votre <br>Entreprise Avec Moi</h2>
											<p>
											Je suis le coach de vie unique pour les solutions de votre entreprise, prêt à relever les défis et à résoudre vos problèmes commerciaux. 
											</p>
							...
							<div class="container">
								<div class="row">
									<div class="col-sm-12">
										<div class="single-slide-item-content">
											<h2>
											Ateliers de Groupe  <br>de Coaching
											</h2>
											<p>
											Rejoignez notre communauté et faites passer votre entreprise au niveau supérieur tout en trouvant un équilibre de vie sain.  
											</p>
											<button type="button"  class="slide-btn">
												S'inscrire
											</button>
			...
			<div class="container">
				<div class="we-do-details">
					<div class="section-header text-center">
						<h2>Mission du Coach</h2>
						<p>
							Ma mission en tant que coach individuel est d'accompagner mes clients dans l'atteinte de leurs objectifs personnels et professionnels en leur fournissant un soutien personnalisé et des stratégies adaptées à leurs besoins spécifiques. 
						</p>
					</div><!--/.section-header-->
								...
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
											Les ateliers en groupe permettent de partager des idées et de développer des solutions ensemble.
											</p>
										</div><!--/.we-do-comment-->
							...
							<div class="col-sm-4 col-xs-12">
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
											Les formations des entreprises améliorent les compétences des équipes pour une meilleure performance.
											</p>
										</div><!--/.we-do-comment-->
									</div><!--/.we-do-description-->
								</div><!--/.single-we-do-box-->
							...
							<div class="col-sm-4 col-xs-12">
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
											Le coaching des compétences développe et renforce les aptitudes nécessaires pour atteindre vos objectifs.
											</p>
										</div><!--/.we-do-comment-->
									</div><!--/.we-do-description-->
								</div><!--/.single-we-do-box-->
						...
						<div class="col-sm-6">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>A propos</h2>
									<p>
									Je suis Maroua Marzougui, coach professionnel certifiée (RNCP), spécialisée dans l'accompagnement des mamans entrepreneuses. Avec 10 années d'expérience en coaching, en recrutement des talents et en gestion d'entreprise, je comprends les défis uniques auxquels vous faites face en jonglant entre votre rôle de mère et celui d'entrepreneure. Ma mission est de vous aider à réussir dans les deux domaines en vous offrant des outils pratiques, un soutien personnalisé et une inspiration continue.
									</p>
									<div class="project-btn">
										<a href="about.php"  class="project-view">Voir plus
										</a>
									</div><!--/.project-btn-->
								</div><!--/.about-us-txt-->
							</div><!--/.single-about-us-->
						...
						<div class="col-sm-6">
							<div class="single-about-us">
								<div class="about-us-img">
									<img src="assets/images/about/marwa.jpg" alt="about images">
								</div><!--/.about-us-img-->
							</div><!--/.single-about-us-->
						</div><!--/.col-->
					</div><!--/.row-->
				...
				<div class="container">
					<div class="service-details">
						<div class="section-header text-center">
							<h2>Mes Services</h2>
							<p>
							Mes services personnalisés sont conçus pour aider les mamans à équilibrer leurs responsabilités professionnelles et personnelles tout en atteignant leurs objectifs de carrière.	
							</p>
						</div><!--/.section-header-->
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											<h2>
												<a href="#">Coaching de leadership</a>
											</h2>
											<p>
							...
							<div class="row">
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											<h2>
												<a href="#">Formations en entreprise</a>
											</h2>
											<p>
												Lorem ipsum dolo dolor in  in voluptate velit esse cillum dolore. epteur sint oat cupidatat 
											</p>
			...
			<div class="container">
				...
				<div class="owl-carousel owl-theme" id="testemonial-carousel">
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="assets/images/client/download.png" alt="img"/>
							</div><!--/.home1-testm-img-->
							<div class="home1-testm-txt">
								...
								<p>
								Marwa is a very caring, supportive and outstanding professional. She helped me through my recruitment process with an enthusiastic, committed and proactive spirit. 	
								</p>
								<h3>
									<a href="#">
									Jessica Magallanes García
									</a>
								</h3>
								<h4>Expert marketing, Méxique</h4>
							</div><!--/.home1-testm-txt-->	
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="assets/images/client/samar.jpg" alt="img"/>
							</div><!--/.home1-testm-img-->
							<div class="home1-testm-txt">
								<span class="icon section-icon">
									<i class="fa fa-quote-left" aria-hidden="true"></i>
								...
								<p>
								Marwa a toutes les qualités d'une coach de talent : passionnée, engagée à 100% auprès de ses coachés, et capable de se baser sur leurs particularités et personnalités pour leur proposer des séances de coaching de qualité.
								Je suis super reconnaissante pour tout ce qu'elle m'a transmis, et pour tout le travail de réflexion que cela m'a permis de faire pour me recentrer et trouver l'équilibre pro/perso qui manquait (terriblement) à ma vie !
								</p>
								<h3>
									<a href="#">
										Maha Kaabi
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="assets/images/client/client.jpg" alt="img"/>
							</div><!--/.home1-testm-img-->
							<div class="home1-testm-txt">
								<span class="icon section-icon">
									<i class="fa fa-quote-left" aria-hidden="true"></i>
								...
								<p>
								Grâce à ce coaching, j'ai pris confiance en moi et j'ai pu évoluer dans ma carrière. Marwa est très professionnelle, à l'écoute, elle m'a aidée beaucoup à développer mes potentiels.
								En conclusion, très bonne expérience personnelle. MERCI MARWA
								</p>
								<h3>
									<a href="#">
										Samar Cherif
								...
								<h4>Conseiller en assurance, Tunis</h4>
							</div><!--/.home1-testm-txt-->	
						</div><!--/.home1-testm-single-->
					</div><!--/.item-->
					...
					<div class="news-card news-card-pb-25">
							<div class="row">
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
											<img src="assets/images/blog/stress.jpg" alt="blog image">
											<div class="isotope-overlay">
												<a href="stress.html">
													<span class="lnr lnr-link"></span>
										...
										<div class="news-box-inner">
											<h3>
												<a href="stress.html">
												Comment le Stress Affecte la Performance des Mompreneurs
												</a>
											</h3>
											<p class="news-meta">
												Posté par:  <span>Maroua Marzougui - Janvier le 12, 2024</span>
											</p>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
											<img src="assets/images/blog/goals.jpg" alt="blog image">
											<div class="isotope-overlay">
										...
										<div class="news-box-inner">
											<h3>
												<a href="blog_single.html">
												Mamans Entrepreneures Débutantes : Comment Démarrer Votre Entreprise avec Succès ?												</a>
											</h3>
											<p class="news-meta">
											Postée par:  <span>Maroua Marzougui - Mai le 14, 2024</span>
											</p>
											<!-- <a href="#" class="learn-btn">
												learn more
											</a> -->
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
											<img src="assets/images/blog/coworker.jpg" alt="blog image">
											<div class="isotope-overlay">
												<a href="blog_single.html">
													<span class="lnr lnr-link"></span>
										...
										<div class="news-box-inner">
											<h3>
												<a href="blog_single.html">
												Help!!I need to deal with my rude co-worker!
												</a>
											</h3>
											<p class="news-meta">
												Postée par:  <span>Maroua Marzougui</span> - <span>Mai le 14, 2024</span>
											</p>
											<!-- <a href="#" class="learn-btn">
												learn more
											</a> -->
							...
							<div class="project-btn text-center">
								<a href="blog.html"  class="project-view">Voir Plus
								</a>
							</div><!--/.project-btn-->
					</div><!--/.news-card-->
